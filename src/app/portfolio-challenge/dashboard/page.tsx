  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="space-y-6 text-white/80 leading-relaxed">
        ...
        <div className="border-t border-white/10 pt-6">
          <a href="/institutional/index.html" className="inline-block rounded-lg bg-white text-black px-6 py-3 font-medium hover:bg-white/90 transition-colors">
      ...
      <div className="space-y-6 text-white/80 leading-relaxed">
        ...
        <div className="bg-white/5 rounded-lg p-6 border border-white/10">
          ...
          <div className="flex gap-4">
            <a href="/institutional/product.html" className="inline-block rounded-lg bg-white text-black px-6 py-3 font-medium hover:bg-white/90 transition-colors text-sm">
              View Full Strategy Details →
            </a>
            <a href="/institutional/simulator.html" className="inline-block rounded-lg border border-white/20 px-6 py-3 font-medium text-white hover:bg-white/5 transition-colors text-sm">
      ...
      <div className="space-y-6 text-white/80 leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white/5 rounded-lg p-6 border border-white/10">
            ...
            <a href="/resources.html" className="inline-block rounded-lg border border-white/20 px-6 py-3 font-medium text-white hover:bg-white/5 transition-colors">
              View Resources →
            </a>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 pt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <a href="/institutional/product.html" className="bg-white/5 rounded-lg p-4 border border-white/10 hover:bg-white/10 transition-colors">
            ...
            <a href="/about.html" className="bg-white/5 rounded-lg p-4 border border-white/10 hover:bg-white/10 transition-colors">
            ...
            <a href="/institutional/simulator.html" className="bg-white/5 rounded-lg p-4 border border-white/10 hover:bg-white/10 transition-colors">
            ...
            <a href="/institutional/index.html" className="bg-white/5 rounded-lg p-4 border border-white/10 hover:bg-white/10 transition-colors">
        ...
        <div className="border-t border-white/10 pt-6">
          ...
          <div className="space-y-2 text-white/70">
            <p>
              <strong className="text-white">Website:</strong> <a href="/" className="text-amber-400 hover:text-amber-300 underline">firstprincipleam.com</a>
            </p>
            <p>
