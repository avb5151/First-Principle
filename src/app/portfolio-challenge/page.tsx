...
export default function PortfolioChallengePage() {
  return (
      ...
      >
        ...
        <div className="mt-8 pt-8 border-t border-white/10">
          ...
          <div className="flex flex-wrap gap-4">
            <a href="/institutional/index.html" className="text-white/70 hover:text-white underline text-sm">
              Our Approach
            </a>
            <a href="/institutional/product.html" className="text-white/70 hover:text-white underline text-sm">
              Strategy Details
            </a>
            <a href="/about.html" className="text-white/70 hover:text-white underline text-sm">
              About Us
            </a>
            <a href="/contact.html" className="text-white/70 hover:text-white underline text-sm">
              Contact
            </a>
          </div>
        </div>
